...
| Pendiente en Word (no automatizable) | Pegar el **escudo de la universidad** en el lugar reservado de la portada; completar los **nombres del tribunal** en la hoja de aprobación; decidir si se incluyen **dedicatoria y agradecimientos** (opcionales); revisar que el **nombre completo** del autor sea el correcto en la portada; y trasladar el **resumen** a los preliminares, porque hoy queda como primer bloque del cuerpo |
