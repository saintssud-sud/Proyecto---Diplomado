...
| Epígrafe de las figuras | Va **debajo**, conforme al módulo («las figuras llevan epígrafe debajo, las tablas llevan su título encima»). Esto resuelve una contradicción entre dos documentos del propio proyecto: la nota del archivo de diagramas decía «título arriba», que es la convención de las tablas |
