...
| Figuras: total | 12 imágenes en `Figuras/` (9 bocetos de pantalla y 3 diagramas técnicos), unos 550 KB, más el diagrama de antecedentes, que sigue existiendo solo como código Mermaid. Queda pendiente insertarlas en Word e incorporarlas al índice de figuras |
